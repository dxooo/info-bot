...
async def on_ready():
    ...
    print(bot.user.id)
    print('------')
    game = discord.Game("Assisting the San Andreas State Police")
...
async def poll(ctx, arg1):
    ...
    embed.set_author(name="San Andreas State Police Info Bot", icon_url="https://cdn.discordapp.com/attachments/376272498418778114/548697879796121603/khp_logo_w_skew_w_stroke_2.png")
    
    embed.add_field(name="Yes!", value="React with ðŸ‘", inline=False)
    embed.add_field(name="No!", value="React with ðŸ‘Ž", inline=False)
    embed.add_field(name="I'm not sure!", value="React with ðŸ¤·", inline=False)
...
async def on_member_join(member):
    print('User Joined')
    embed = discord.Embed(title="__Welcome to the San Andreas San Andreas State Police Discord!__", description="_Here are a few tips & tricks to get you started!_", color=0x3D59AB)
    ...
    embed.add_field(name="Channels", value="Regardless if you're a Cadet or Officer you will have access to the 'SAHP General' category of channels, these are general hangout places with some self explanatory names, please make sure you're using each channel appropriately", inline=False)
...
@bot.command()
async def links(ctx):
    embed = discord.Embed(title="__San Andreas State Police Quick Links__", description="_Used to convey quick links to important information about the San Andreas State Police_", color=0x3D59AB)
...
async def embe(ctx,ar,arg,arg2,arg3,arg4):
    ...
    embed.set_author(name="{}".format(ar), icon_url="https://cdn.discordapp.com/attachments/376272498418778114/548697879796121603/khp_logo_w_skew_w_stroke_2.png")
...
@bot.command()
async def info(ctx):
    embed = discord.Embed(title="__San Andreas State Police Information Bot__", description="_Used to convey information about HighSpeed-Gaming's San Andreas State Police_", color=0x3D59AB)
    
    embed.set_author(name="San Andreas State Police Info Bot", icon_url="https://cdn.discordapp.com/attachments/376272498418778114/548697879796121603/khp_logo_w_skew_w_stroke_2.png")

    embed.add_field(name="Author", value="Colonel M. Cortez (brandon#9648), Lieutenant R. Reddington (Raymond#2592)")
...
@bot.command()
async def cmds(ctx):
    embed = discord.Embed(title="__San Andreas State Police Information Bot__", description="_List of commands are:_", color=0x3D59AB)
    ...
    embed.add_field(name="!links", value="Gives a list of important links for the San Andreas State Police", inline=False)
    embed.add_field(name="!divisions", value="Gives the list of San Andreas State Police Divisions and their Division Heads", inline=False)
...
async def divisions(ctx):
    embed = discord.Embed(title="__San Andreas State Police Divisions__", description="_Divisions within the San Andreas State Police are:_", color=0x3D59AB)
    ...
    embed.add_field(name="06 Aviation and Marine Unit (!amu)", value="Lead by Lead Officer G. Green and LT. A. Spahalski", inline=False)
...
async def adm(ctx):
    ...
    embed.add_field(name="Leaders", value="Lead Officer A. Vyrilis", inline=False)
...
async def pat(ctx):
    ...
    embed.add_field(name="Description", value="The main division within the San Andreas State Police, housing every member of the San Andreas State Police regardless of status within other divisions", inline=False)
...
async def ted(ctx):
    ...
    embed.add_field(name="Description", value="The Traffic Enforcement Division is a specialized division within the San Andreas San Andreas State Police that was originally created to combat driving under the influence and careless driving in general", inline=False)
...
async def k9(ctx):
    ...
    embed.add_field(name="Leaders", value="Senior Officer Mike Anderson and Senior Officer Ben Thomas", inline=False)
...
async def csu(ctx):
    ...
    embed.add_field(name="Leaders", value="Sergeant R. Reddington and Lead Officer A. Vyrilis", inline=False)
...
async def amu(ctx):
    ...
    embed.add_field(name="Leaders", value="Lead Officer G. Green", inline=False)
...
async def aca(ctx):
    ...
    embed.add_field(name="Leaders", value="Lt B. Vance", inline=False)
