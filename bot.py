...
13.39 Felony Speeding"""
    ...
    for line in temporary.splitlines():
      if us_inpt not in line:
    embed=discord.Embed(title="__Penal Code Lookup__", description="It looks like you searched for: "+us_inpt, color=0x3D59AB)
    embed.set_author(name="State Police Info Bot", icon_url="https://cdn.discordapp.com/attachments/393324031505465344/471855906699739136/sasp_logo_updated_2018.png")
    embed.add_field(name="Here's what we found based on your search:", value="It appears we could not find a result based on your input.", inline=False)
      if us_inpt in line:
